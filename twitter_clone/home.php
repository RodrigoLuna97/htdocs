...
if (!isset($_SESSION['usuario'])) {
	...
	$sql = "SELECT count(*) as qtd_seguidores FROM seguidores where seguindo_id_usuario = $id_usuario";
	    			...
	    			<div class="panel-body">
	    				<form id="form_tweet"  class="input-group">
	    					...
	    					<span class="input-group-btn"> 
	    						<button class="btn btn-default" id="btn_tweet" type="button"> Tweetar </button>
	    					</span>
	    				</form>
	    			</div>	
	    		</div>
